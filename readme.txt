...
You can contribute to the source code in our [GitHub](https://www.github.com/gabrielfroes/my_youtube_recommendation) page.
...
e.g. `[my_youtube limit=3 layout=list]`
...
Bugs can be reported either in our support forum or preferably on the [GitHub repository](https://www.github.com/gabrielfroes/my_youtube_recommendation/issues).

= Can I contribute? =

Yes you can! Join in on our [GitHub repository](https://www.github.com/gabrielfroes/my_youtube_recommendation/) :)

== Changelog ==
= 1.0.0 - 04-11-2020 =
* Initial Public Release

[See changelog for all versions](https://raw.githubusercontent.com/gabrielfroes/my_youtube_recommendation/master/changelog.txt).
